...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Branches / Edit #{{$branch->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('branches.update', $branch->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('branch_name')) has-error @endif">
                    ...
                    <input type="text" id="branch_name-field" name="branch_name" class="form-control" value="{{ is_null(old("branch_name")) ? $branch->branch_name : old("branch_name") }}"/>
