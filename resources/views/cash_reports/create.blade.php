...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Cash_reports / Create </h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('cash_reports.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('branch_name')) has-error @endif">
                    ...
                    <input type="text" id="monthly_totals-field" name="monthly_totals" class="form-control" value="{{ old("monthly_totals") }}"/>
                    ...
                    <input type="text" id="cash_month-field" name="cash_month" class="form-control date-picker" value="{{ old("cash_month") }}"/>
