...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Designations / Edit {{$designation->designation_name}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('designations.update', $designation->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('designation_name')) has-error @endif">
                    ...
                    <input type="text" id="designation_name-field" name="designation_name" class="form-control" value="{{ is_null(old("designation_name")) ? $designation->designation_name : old("designation_name") }}"/>
