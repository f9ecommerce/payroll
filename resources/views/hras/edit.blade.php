...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Hras / Edit #{{$hra->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('hras.update', $hra->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('devision_name')) has-error @endif">
                    ...
                    <input type="text" id="devision_name-field" name="devision_name" class="form-control" value="{{ is_null(old("devision_name")) ? $hra->devision_name : old("devision_name") }}"/>
                    ...
                    <input type="text" id="emp_name-field" name="emp_name" class="form-control" value="{{ is_null(old("emp_name")) ? $hra->emp_name : old("emp_name") }}"/>
                    ...
                    <input type="text" id="hra-field" name="hra" class="form-control" value="{{ is_null(old("hra")) ? $hra->hra : old("hra") }}"/>
                       @if($errors->has("hra"))
