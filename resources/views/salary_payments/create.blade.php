...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Salary_payments / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('salary_payments.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('month')) has-error @endif">
                    ...
                    <input type="text" id="increment-field" name="increment" class="form-control" value="{{ old("increment") }}"/>
                    ...
                    <input type="text" id="abscent-field" name="abscent" class="form-control" value="{{ old("abscent") }}"/>
                    ...
                    <input type="text" id="adjusted_abscent-field" name="adjusted_abscent" class="form-control" value="{{ old("adjusted_abscent") }}"/>
                    ...
                    <input type="text" id="ot_amount-field" name="ot_amount" class="form-control" value="{{ old("ot_amount") }}"/>
                    ...
                    <input type="text" id="adj_otdays-field" name="adj_otdays" class="form-control" value="{{ old("adj_otdays") }}"/>
                    ...
                    <input type="text" id="basic-field" name="basic" class="form-control" value="{{ old("basic") }}"/>
                       @if($errors->has("basic"))
                    ...
                    <input type="text" id="salary_advance-field" name="salary_advance" class="form-control" value="{{ old("salary_advance") }}"/>
                    ...
                    <input type="text" id="allowance-field" name="allowance" class="form-control" value="{{ old("allowance") }}"/>
                    ...
                    <input type="text" id="other_allowance-field" name="other_allowance" class="form-control" value="{{ old("other_allowance") }}"/>
                    ...
                    <input type="text" id="sal_to_be_paid-field" name="sal_to_be_paid" class="form-control" value="{{ old("sal_to_be_paid") }}"/>
                    ...
                    <input type="text" id="od_open_amount-field" name="od_open_amount" class="form-control" value="{{ old("od_open_amount") }}"/>
                    ...
                    <input type="text" id="od_close_amount-field" name="od_close_amount" class="form-control" value="{{ old("od_close_amount") }}"/>
                    ...
                    <input type="text" id="pay_salary-field" name="pay_salary" class="form-control" value="{{ old("pay_salary") }}"/>
