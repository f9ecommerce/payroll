...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Set_salary_reports / Edit #{{$set_salary_report->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('set_salary_reports.update', $set_salary_report->id) }}" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('branch')) has-error @endif">
                       <label for="branch-field">Branch</label>
                    <input type="text" id="branch-field" name="branch" class="form-control" value="{{ is_null(old("branch")) ? $set_salary_report->branch : old("branch") }}"/>
                    ...
                    <input type="text" id="division_name-field" name="division_name" class="form-control" value="{{ is_null(old("division_name")) ? $set_salary_report->division_name : old("division_name") }}"/>
                    ...
                    <input type="text" id="emp_name-field" name="emp_name" class="form-control" value="{{ is_null(old("emp_name")) ? $set_salary_report->emp_name : old("emp_name") }}"/>
                    ...
                    <input type="text" id="salary_month-field" name="salary_month" class="form-control date-picker" value="{{ is_null(old("salary_month")) ? $set_salary_report->salary_month : old("salary_month") }}"/>
